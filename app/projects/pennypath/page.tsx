      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4 text-base text-gray-700 leading-relaxed">
            <p>
              A beginner-friendly personal finance web app designed to remove shame and complexity from money tracking for students and freelancers.
            </p>
            <p>
              I designed the user flows, language, and structure to make personal finance feel calm and approachable, using Base44 to scaffold a functional web app.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="flex flex-wrap gap-3">
            {['React (via Base44)', 'UX Design', 'Product Thinking'].map((tech) => (
              <span
                key={tech}
