...
export default function Projects() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 py-12 pt-[140px]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl lg:text-3xl text-gray-400 max-w-3xl mx-auto font-light leading-relaxed mb-16">
            From tools that understand humans, to worlds of ideas, to experiments in code. 
      ...
      {/* Project 1: SibsLove - Pink/Rose World (MOST INTIMATE - DEEPENED) */}
        ...
        <div className="relative z-10 w-full px-6 sm:px-8 lg:px-16 py-12 lg:py-16">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-5 gap-10 lg:gap-12">
              {/* Left: Content with progression */}
              <div className="lg:col-span-3 space-y-8">
                {/* Layer 1: Entry */}
                <div className="space-y-6">
                  <div className="overflow-hidden">
                    <span className="inline-block text-sm font-mono text-pink-300/60 uppercase tracking-wider animate-[fadeIn_0.6s_ease-out]">
                      The Comfort Space
                    </span>
                  </div>
                  
                  <div className="overflow-hidden">
                    <h2 className="text-6xl sm:text-7xl lg:text-8xl font-black tracking-tighter leading-[0.9] animate-[fadeIn_0.8s_ease-out_0.2s_backwards]">
                      SibsLove
                    </h2>
                  </div>
                  
                  <p className="text-3xl sm:text-4xl lg:text-5xl text-pink-300 font-light leading-[1.2] animate-[fadeIn_1s_ease-out_0.4s_backwards]">
                    When you need<br />someone to listen
                  </p>
                </div>

                {/* Layer 2: Core message */}
                <div className="space-y-8 animate-[fadeIn_1.2s_ease-out_0.6s_backwards]">
                ...
                {/* Layer 3: Personal story */}
                <div className="border-l-2 border-pink-500/20 pl-8 py-6 space-y-6 animate-[fadeIn_1.4s_ease-out_0.8s_backwards] hover:border-pink-500/40 transition-colors duration-500">
                ...
                {/* Layer 4: What it offers */}
                <div className="grid sm:grid-cols-2 gap-4 animate-[fadeIn_1.6s_ease-out_1s_backwards]">
                  <div className="group p-4 rounded-xl bg-pink-950/20 border border-pink-500/10 hover:bg-pink-950/30 hover:border-pink-500/20 transition-all duration-500">
                ...
                {/* Layer 5: Entry point */}
                <div className="pt-8 animate-[fadeIn_1.8s_ease-out_1.2s_backwards]">
                  <Link
              ...
              {/* Right: Atmospheric active panel */}
              <div className="lg:col-span-2 order-first lg:order-last">
                <div className="sticky top-32 space-y-8">
                  {/* Main atmosphere panel */}
                  <div className="group relative aspect-square rounded-3xl bg-gradient-to-br from-pink-500/20 via-rose-500/10 to-pink-900/20 border border-pink-500/20 overflow-hidden transition-all duration-700 hover:border-pink-500/40">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative w-full h-full p-12">
                        ...
                        {/* Orbiting elements */}
                        <div className="absolute top-1/4 left-1/4 w-3 h-3 rounded-full bg-pink-400/40 animate-[float_8s_ease-in-out_infinite]"></div>
                        <div className="absolute bottom-1/4 right-1/4 w-2 h-2 rounded-full bg-rose-400/40 animate-[float_6s_ease-in-out_infinite_2s]"></div>
                        <div className="absolute top-1/2 right-1/4 w-2 h-2 rounded-full bg-pink-300/40 animate-[float_7s_ease-in-out_infinite_1s]"></div>
      ...
      {/* Project 2: PennyPath - Purple/Indigo World (CALM & GROUNDING) */}
      <section className="relative border-t border-white/5">
      ...
      {/* Project 3: CareerIQ - Blue/Cyan World (STRUCTURED & ANALYTICAL) */}
      <section className="relative border-t border-white/5">
      ...
      {/* Project 4: Newsletter - Orange World */}
        ...
        <div className="relative z-10 w-full px-6 sm:px-8 lg:px-16">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div>
                <div className="mb-4">
                  <span className="text-xs font-mono text-teal-400/60 uppercase tracking-wider">The Analysis Space</span>
                </div>
                ...
                <div className="space-y-4 text-sm sm:text-base text-gray-400 leading-relaxed mb-8">
                  <p>
                    ...
                    and tone. Built to make emotional intelligence more accessible.
                  </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div>
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 border border-orange-600/50 hover:bg-orange-600/10 text-orange-300 font-medium rounded-lg transition-all duration-200"
                >
                  Explore the ecosystem
                </Link>
              </div>
              <div className="order-first lg:order-last">
                <div className="aspect-square rounded-2xl bg-gradient-to-br from-orange-500/20 to-amber-500/10 border border-orange-500/20 flex items-center justify-center">
                  <div className="text-center p-8">
                    <p className="text-orange-400 text-lg font-mono">[ Reflection · Growth · Honesty ]</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Project 5: Sentiment Analysis - Teal World */}
      <section className="relative py-16 sm:py-20 border-t border-white/5">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-950/15 via-black to-black"></div>
        <div className="relative z-10 w-full px-6 sm:px-8 lg:px-16">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div>
                ...
                <div className="space-y-4 text-sm sm:text-base text-gray-400 leading-relaxed mb-8">
                  <p>
                    A tool that analyzes emotional patterns in text, helping understand sentiment 
                    and tone. Built to make emotional intelligence more accessible through natural language processing.
                  </p>
                  <p className="text-teal-400/60 italic text-sm">
                    "Words carry emotion. This tool helps decode what's being said beneath the surface."
                  </p>
      ...
      {/* Project 6: Suika Lite - Green World (EXPERIMENTAL) */}
      <section className="relative py-16 sm:py-20 border-t border-white/5">
      ...
      {/* Closing Section - Continuity & Anticipation */}
      <section className="relative py-20 sm:py-28 lg:py-32 px-6 border-t border-white/5">
        <div className="absolute inset-0 bg-gradient-to-t from-purple-950/10 to-black"></div>
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h3 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tighter mb-8">
            The Work Continues
          </h3>
          <div className="space-y-6 text-lg sm:text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
            <p>
              Each tool is a different attempt to make technology more human. Some address shame. 
              Some address loneliness. Some address confusion. Some just explore what's possible.
            </p>
            <p>
              More worlds are being built. More problems are being explored. More experiments 
              are underway.
            </p>
            <p className="text-purple-400 font-medium">
              This is World One. There will be others.
            </p>
          </div>
