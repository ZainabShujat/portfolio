...
export default function SuikaLite() {
  const images = [
    { src: '/images/projects/suika-lite/hero.png', alt: 'Suika Lite game interface' },
    { src: '/images/projects/suika-lite/feature-1.png', alt: 'Suika Lite gameplay screenshot' },
    { src: '/images/projects/suika-lite/feature-2.png', alt: 'Suika Lite gameplay screenshot' },
    { src: '/images/projects/suika-lite/feature-3.png', alt: 'Suika Lite gameplay screenshot' },
  ]
      ...
      <div className="px-6 sm:px-8 lg:px-16 py-12 lg:py-16 pt-[200px]">
        <div className="max-w-6xl mx-auto">
          ...
          <section className="mb-12">
            <div 
              className="relative h-[400px] bg-gradient-to-br from-green-900/20 to-teal-900/20 border border-white/10 rounded-2xl overflow-hidden group cursor-grab active:cursor-grabbing"
